...
black = (0, 0, 0)
yellow = (255, 255, 0)
frame = pygame.display.set_mode((200, 200)) #scaled by 2
...
while True:
	...
	pygame.draw.line(frame,red,[40, 120], [100, 180],2)
	pygame.draw.line(frame,red,[100, 180], [150, 120],2)
	...
	if(x > 100):
		...
		pygame.draw.rect(frame, yellow, [100, 180, 2, 200])
	if(x >150):
